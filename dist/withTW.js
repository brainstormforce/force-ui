...
function g(r) {
  ...
  return e === "[object RegExp]" || e === "[object Date]" || E(r);
}
var u = typeof Symbol == "function" && Symbol.for, f = u ? Symbol.for("react.element") : 60103;
function E(r) {
  return r.$$typeof === f;
}
function p(r) {
...
function F(r, e) {
  return e.clone !== !1 && e.isMergeableObject(r) ? a(p(r), r, e) : r;
}
function y(r, e, o) {
...
function d(r) {
  return Object.keys(r).concat(m(r));
}
function b(r, e) {
  try {
    return e in r;
...
function A(r, e) {
  return b(r, e) && !(Object.hasOwnProperty.call(r, e) && Object.propertyIsEnumerable.call(r, e));
}
function h(r, e, o) {
  var t = {};
  return o.isMergeableObject(r) && d(r).forEach(function(n) {
    t[n] = F(r[n], o);
  }), d(e).forEach(function(n) {
    A(r, n) || (b(r, n) && o.isMergeableObject(e[n]) ? t[n] = B(n, o)(r[n], e[n], o) : t[n] = F(e[n], o));
  }), t;
}
function a(r, e, o) {
  o = o || {}, o.arrayMerge = o.arrayMerge || y, o.isMergeableObject = o.isMergeableObject || l, o.cloneUnlessOtherwiseSpecified = F;
  var t = Array.isArray(e), n = Array.isArray(r), i = t === n;
  return i ? t ? o.arrayMerge(r, e, o) : h(r, e, o) : F(e, o);
}
a.all = function(e, o) {
  if (!Array.isArray(e))

...
}, d = "border-0 border-r border-border-subtle border-solid", i = "bg-background-primary text-primary cursor-pointer flex items-center justify-center", c = "hover:bg-button-tertiary-hover", b = "focus:outline-none";
export {
  i as baseClasses,
  d as borderClasses,
  e as colorClassNames,
  s as disabledClassNames,
  b as focusClasses,
  c as hoverClasses,
  r as sizeClassNames,
  t as sizes,
  o as textSizeClassNames
};

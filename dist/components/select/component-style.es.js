...
}, s = "h-px my-2 w-full border-border-subtle border-b border-t-0 border-solid", r = {
...
export {
  t as disabledClassNames,
  s as optionGroupDividerClassNames,
  r as optionGroupDividerSizeClassNames,
  o as selectItemClassNames,
  e as sizeClassNames
};

...
const q = ({
  ...
  const s = v(0), l = v(0), t = v(), k = (u, A = o) => {
    if (!(!y || o < 0))
      return s.current = (/* @__PURE__ */ new Date()).getTime(), setTimeout(() => {
        typeof i == "function" && i(u.id);
      }, A);
  }, E = () => {
    clearTimeout(t.current), l.current = (/* @__PURE__ */ new Date()).getTime();
  }, _ = () => {
    t.current = k(
      n,
      o - (l.current - s.current)
    );
  };
  N(() => {
    const u = o;

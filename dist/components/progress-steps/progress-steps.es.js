...
import { Plus as I, Check as v } from "lucide-react";
...
const F = {
  ...
  return l === "stack" ? /* @__PURE__ */ N("div", { className: "relative flex-1 justify-center", children: [
    /* @__PURE__ */ N(
      "div",
      {
        className: o("flex items-center flex-col", s),
        ...g,
        children: [
          h,
          w()
    ...
    /* @__PURE__ */ N("div", { className: o("flex items-center", s), ...g, children: [
      h,
      w()
    ] }),
    S()
...
const O = (r, f, n, t, s, l, m, d = "icon", c = /* @__PURE__ */ e(v, {})) => {
  if (f)
    ...
    ) : /* @__PURE__ */ e("span", { className: j(t, s), children: c });
  const b = L(!!n, t, s), p = E(
    r,
    n,
    t,

...
import l, { useState as V, cloneElement as w, Fragment as j, isValidElement as y, createContext as U, useContext as q } from "react";
import { useFloating as z, autoUpdate as B, offset as G, flip as H, shift as J, useClick as K, useDismiss as Q, useRole as X, useInteractions as Y, useTransitionStyles as Z, FloatingFocusManager as _, FloatingPortal as $ } from "@floating-ui/react";
...
const N = ({
  ...
  return !M || !p ? null : /* @__PURE__ */ s(_, { context: p, modal: !1, children: /* @__PURE__ */ s(
    "div",
    {
      ref: n.setFloating,
      className: o,
...
const x = ({
  ...
  root: o,
  id: n
}) => /* @__PURE__ */ s($, { id: n, root: o, children: e });

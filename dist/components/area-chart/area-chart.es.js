...
const q = "#6B7280", J = [
  ...
  const c = {
    ...
    md: "14px",
    lg: "16px"
  }, n = c[v] || c.sm, R = () => /* @__PURE__ */ t("defs", { children: i.map((r, e) => /* @__PURE__ */ d(
    "linearGradient",
    {
      id: `fill${e}`,
      x1: "0",
  ...
  return !o || o.length === 0 ? b || /* @__PURE__ */ t(Y, { size: "sm", variant: "help", children: "No data available" }) : /* @__PURE__ */ t("div", { role: "img", "aria-label": "Area chart", children: /* @__PURE__ */ t($, { width: z, height: T, children: /* @__PURE__ */ d(G, { ...B, data: o, children: [

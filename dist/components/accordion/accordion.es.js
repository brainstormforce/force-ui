...
import { AnimatePresence as P, motion as y } from "framer-motion";
...
C.displayName = "Accordion.Trigger";
const N = ({
  isOpen: n,
  disabled: s = !1,
  type: r = "simple",
  ...
  return /* @__PURE__ */ t(
    "div",
    {
      ...
      "aria-labelledby": c,
      "aria-hidden": !n,
      children: /* @__PURE__ */ t(P, { initial: !1, children: n && /* @__PURE__ */ t(
        y.div,
        {
          variants: d,
          initial: "closed",

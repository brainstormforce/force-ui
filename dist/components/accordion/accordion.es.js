...
import { ChevronDown as w, Minus as v, Plus as I } from "lucide-react";
import { AnimatePresence as T, motion as x } from "framer-motion";
...
const g = ({
  ...
  const f = {
    ...
    x.span,
    {
      ...
      children: t ? /* @__PURE__ */ r(v, {}) : /* @__PURE__ */ r(I, {})
    },
    t ? "minus" : "plus"
  ) : null;

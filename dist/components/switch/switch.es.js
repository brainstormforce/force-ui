...
const M = ({
  ...
  }, p = !e?.heading && !e?.description, n = !e?.heading || !e?.description ? "items-center" : "items-start";
  return p ? l : /* @__PURE__ */ d("div", { className: t("inline-flex", n, "gap-3"), children: [
    l,
    u()
  ] });
}, R = ({
  ...
  const n = s === "lg" ? "md" : s, i = C(() => typeof r < "u", [r]), c = C(() => e || `switch-${I()}`, []), [w, D] = E(l), m = "primary", z = H(
    () => i ? r : w,
    [i, r, w]
  ), L = (j) => {
    if (o)

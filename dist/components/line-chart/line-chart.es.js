...
import { ResponsiveContainer as N, LineChart as U, CartesianGrid as j, XAxis as G, YAxis as m, Tooltip as K, Line as b } from "recharts";
...
const l = "#6B7280", V = "#E5E7EB", W = [{ stroke: "#2563EB" }, { stroke: "#38BDF8" }], H = ({
  ...
  const d = f.length > 0 ? f : W, L = {
    ...
    md: "14px",
    lg: "16px"
  }, s = L[I] || L.sm, k = (r = 0) => Array.isArray(i) ? i[r] || i[0] || l : i;
  return !n || n.length === 0 ? M || /* @__PURE__ */ t(P, { size: "sm", variant: "help", children: "No data available" }) : /* @__PURE__ */ t(N, { width: v, height: D, children: /* @__PURE__ */ y(U, { ...R, data: n, children: [
    ...
    e.map((r, o) => {
      let p = "left";
      return a && o > 0 && (p = "right"), /* @__PURE__ */ t(
        b,
        {
          type: "natural",
          dataKey: r,

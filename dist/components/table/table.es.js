...
const y = k(
  ...
  return /* @__PURE__ */ o(
    ...
    {
      value: s,
      children: /* @__PURE__ */ u("div", { className: "flow-root border-0.5 border-solid border-border-subtle rounded-md divide-y-0.5 divide-x-0 divide-solid divide-border-subtle overflow-hidden", children: [
  ...
  const { checkboxSelection: t } = p(), m = (w) => {
  ...
  const { checkboxSelection: c } = p(), t = (m) => {

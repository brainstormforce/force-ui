...
const F = ({
  ...
  const i = s === "donut", y = b, g = i ? x : 0;
  if (!n || n.length === 0)
    return /* @__PURE__ */ t(z, { size: "sm", variant: "help", children: "No data available" });
  const C = n.map((e, L) => ({
    ...e,
    "aria-label": `${e.name ?? `Segment ${L + 1}`}: ${e[a]}`
  }));
  return /* @__PURE__ */ t("div", { role: "img", "aria-label": "Pie chart", children: /* @__PURE__ */ r(
    P,
    {
      width: l,
      height: l,

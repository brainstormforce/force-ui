...
import { mergeRefs as ie } from "../toaster/utils.es.js";
const ae = ({
  variant: c = "dark",
  // 'light' | 'dark';
  placement: h = "bottom",
  ...
  const o = U(
    ...
    enabled: !o && i.includes("click")
  }), E = Z(e, {
    move: !1,
    enabled: !o && i.includes("hover"),
    ...v && { handleClose: _() }
  }), M = $(e, {
    enabled: !o && i.includes("focus")
  ...
  return /* @__PURE__ */ a(g, { children: [
    ...
    /* @__PURE__ */ t(le, { id: k, root: b, children: I && /* @__PURE__ */ a(
      "div",
      {
        className: r(
          D,

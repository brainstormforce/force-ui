...
import { forwardRef as M, useMemo as u, useState as E, useCallback as g, isValidElement as R } from "react";
...
const A = ({
  ...
  }, I = g(() => R(e) ? e : !e?.heading && !e?.description ? null : /* @__PURE__ */ d("div", { className: n[o].gap, children: [

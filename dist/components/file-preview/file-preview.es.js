...
import { ImageOff as d, Trash as u, File as x } from "lucide-react";
const l = {
  sm: {
    image: "w-8 h-8",
    name: "text-xs",
  ...
  const m = () => /* @__PURE__ */ e(
    "span",
    {
      ...
      children: /* @__PURE__ */ e(x, { className: "size-5 text-icon-primary" })
    }
  );
  return /* @__PURE__ */ e(
    "div",
      ...
      children: /* @__PURE__ */ i("div", { className: "flex items-center gap-3 w-full", children: [
        ...
        !o && /* @__PURE__ */ e(
          "button",
          {
            ...
            children: /* @__PURE__ */ e(u, { className: "size-4 text-support-error" })
          }
        )
      ] })
    }

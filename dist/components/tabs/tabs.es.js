...
import R, { useMemo as J, useCallback as O, isValidElement as z, forwardRef as Q, createContext as H, useContext as K } from "react";
import { cn as T } from "../../utilities/functions.es.js";
import { LayoutGroup as X, motion as j } from "framer-motion";
import { nanoid as Y } from "nanoid";
const V = H({}), S = () => K(V), W = H(null), Z = () => K(W), q = ({
  children: s,
  activeItem: a = null,
  ...
  const N = J(() => Y(), []), x = S(), d = "activeItem" in x, P = x?.activeItem || a, g = O(
    (e, c) => {
      r && r({ event: e, value: c });
    },
    [r]
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ b(
          W.Provider,
          {
            ...
            children: /* @__PURE__ */ b(X, { id: N, children: R.Children.map(s, (e) => z(e) ? R.cloneElement(e) : null) })
          }
        )
      }
    )

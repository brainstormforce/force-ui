...
export declare const Select: NamedExoticComponent<SelectProps> & {
    readonly type: {
    ...
    Portal: MemoExoticComponent<typeof SelectPortal>;
    Button: MemoExoticComponent<typeof SelectButton>;
    Options: MemoExoticComponent<typeof SelectOptions>;
    Option: MemoExoticComponent<typeof SelectItem>;
    OptionGroup: MemoExoticComponent<typeof SelectOptionGroup>;
};
...
declare function SelectButton({ children, icon, // Icon to show in the select button.
    ...
    render, label, // Label for the select component.
...
export declare const Sidebar: {
    ({ children, className, onCollapseChange, collapsible, borderOn, ...props }: SidebarProps): JSX_2.Element;
    displayName: string;
} & {
    Header: {

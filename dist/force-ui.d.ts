...
export declare const ButtonGroupButton: default_2.ForwardRefExoticComponent<ButtonProps_2 & default_2.RefAttributes<HTMLButtonElement>>;

export declare const ButtonGroupContainer: ({ children, activeItem, onChange, className, size, iconPosition, }: ButtonGroupProps) => JSX_2.Element;
...
export declare const ContainerItem: {
    ({ grow, shrink, order, alignSelf, justifySelf, className, children, ...props }: FlexItemProps & GridItemProps): JSX_2.Element;
    displayName: string;
};
...
export declare const DatePicker: ({ selectionType, variant, presets: customPresets, onCancel, onApply, onDateSelect, applyButtonText, cancelButtonText, showOutsideDays, isFooter, enableTimeSelection, selected, disabled, ...props }: DatePickerProps) => JSX_2.Element | undefined;
...
export declare const DrawerCloseButton: {
    ({ children, as: Tag, ...props }: DrawerCloseButtonProps): string | number | boolean | Iterable<ReactNode> | JSX_2.Element | null | undefined;
    displayName: string;
};
...
export declare const DrawerPanel: {
    ({ children, className, ariaLabel }: DrawerPanelProps): JSX_2.Element | null;
    displayName: string;
};
...
export declare const DrawerPortal: ({ children, ...props }: DrawerPortalProps) => JSX_2.Element;
...
export declare const DropdownMenuContentWrapper: {
    ({ children, className, }: DropdownMenuContentWrapperProps): JSX_2.Element | null;
    displayName: string;
};
...
export declare const DropdownMenuList: {
    (props: DropdownMenuListProps): JSX_2.Element;
    displayName: string;
};
...
export declare const DropdownMenuPortal: {
    ({ children, root, id, }: DropdownPortalProps): JSX_2.Element;
    displayName: string;
};
...
export declare const DropdownMenuTrigger: default_2.ForwardRefExoticComponent<DropdownCommonProps & default_2.RefAttributes<HTMLDivElement>>;
...
export declare const FilePicker: default_2.ForwardRefExoticComponent<FilePickerProps & Omit<default_2.InputHTMLAttributes<HTMLInputElement>, "size" | "type" | "value" | "onChange"> & default_2.RefAttributes<HTMLInputElement>>;

declare interface FilePickerProps {
    /**
...
export declare const HamburgerMenuOption: MenuOptionComponent;

export declare const HamburgerMenuOptions: FC<MenuOptionsProps>;
...
export declare const HamburgerMenuToggle: {
    ({ className }: MenuToggleProps): JSX_2.Element;
    displayName: string;
};
...
export declare const LineChart: ({ data, dataKeys, seriesLabels, colors, showXAxis, showYAxis, showTooltip, tooltipIndicator, tooltipLabelKey, showCartesianGrid, xAxisTickFormatter, yAxisTickFormatter, tickFormatter, xAxisDataKey, yAxisDataKey, xAxisFontSize, xAxisFontColor, yAxisFontColor, chartWidth, chartHeight, withDots, lineChartWrapperProps, strokeDasharray, gridColor, biaxial, noDataComponent, }: LineChartProps) => string | number | true | Iterable<ReactNode> | JSX_2.Element;
...
export declare const PaginationContent: default_2.ForwardRefExoticComponent<PaginationCommonProps & default_2.RefAttributes<HTMLUListElement>>;
...
export declare const PaginationItem: default_2.ForwardRefExoticComponent<PaginationItemProps & default_2.RefAttributes<HTMLLIElement>>;
...
export declare const SearchBoxContent: {
...
export declare const SearchBoxEmpty: {
...
export declare const SearchBoxGroup: {
...
export declare const SearchBoxInput: default_2.ForwardRefExoticComponent<SearchBoxInputProps & default_2.RefAttributes<HTMLInputElement>>;
...
export declare const SearchBoxItem: default_2.ForwardRefExoticComponent<SearchBoxItemProps & default_2.RefAttributes<HTMLButtonElement>>;
...
export declare const SearchBoxList: {
...
export declare const SearchBoxLoading: {
...
export declare const SearchBoxPortal: {
...
export declare const SearchBoxSeparator: default_2.ForwardRefExoticComponent<SearchBoxSeparatorProps & default_2.RefAttributes<HTMLHRElement>>;
...
export declare const Select: {
    ({ id, size: sizeValue, value, defaultValue, onChange, by, children, multiple, combobox, inlineSearch, disabled, searchPlaceholder, searchFn, debounceDelay, }: SelectProps): JSX_2.Element;
    displayName: string;
} & {
    Portal: typeof SelectPortal;
    Button: ForwardRefExoticComponent<SelectButtonProps & RefAttributes<HTMLElement>>;
    Options: typeof SelectOptions;
    Option: typeof SelectItem;
    OptionGroup: typeof SelectOptionGroup;
};

export declare const SelectButton: ForwardRefExoticComponent<SelectButtonProps & RefAttributes<HTMLElement>>;
...
declare type SelectFunctionChildren = ({ value, }: {
...
export declare function SelectOptionGroup({ label, children, className, ...props }: SelectOptionGroupProps): JSX_2.Element;

export declare namespace SelectOptionGroup {
    var displayName: string;
}
...
export declare function SelectOptions({ children, className, }: SelectOptionsProps): JSX_2.Element;
...
export declare function SelectPortal({ children, root, id }: SelectPortalProps): JSX_2.Element;
...
export declare const SidebarBody: {
    ({ children }: SidebarCommonProps): JSX_2.Element;
    displayName: string;
};
...
export declare const TableFooter: default_2.FC<TableFooterProps>;
...
export declare const TableHeadCell: default_2.FC<TableHeadCellProps>;
...
export declare const TabsGroup: {
    ({ children, activeItem: activeTabSlug, onChange, className, size, orientation, variant, iconPosition, width, "aria-label": ariaLabel, }: TabsGroupProps): JSX_2.Element;
    displayName: string;
};
...
export declare const TabsTab: default_2.ForwardRefExoticComponent<TabProps & default_2.RefAttributes<HTMLButtonElement>>;
...
export declare const TextArea: ForwardRefExoticComponent<TextAreaProps & Omit<TextareaHTMLAttributes<HTMLTextAreaElement>, "size" | "onChange"> & RefAttributes<HTMLTextAreaElement>>;
...
export declare const TopbarItem: {
    ({ children, className }: TopbarCommonProps): JSX_2.Element;
    displayName: string;
};

export declare const TopbarLeft: {
    ({ gap, children, className }: TopbarProps): JSX_2.Element;
    displayName: string;
};

export declare const TopbarMiddle: {
    ({ gap, children, align, className, }: TopbarMiddleProps): JSX_2.Element;
    displayName: string;
};
...
export declare const TopbarRight: {
    ({ gap, children, className }: TopbarProps): JSX_2.Element;
    displayName: string;
};

...
export declare const BarChart: ({ data, dataKeys, colors, layout, stacked, showXAxis, showYAxis, showTooltip, tooltipIndicator, tooltipLabelKey, showLegend, showCartesianGrid, tickFormatter, xAxisDataKey, yAxisDataKey, xAxisFontSize, xAxisFontColor, yAxisFontColor, chartWidth, chartHeight, borderRadius, }: BarChartProps) => JSX_2.Element;
...
export declare const DropdownMenu: {
    ({ placement, offset: offsetValue, boundary, dropdownPortalRoot, dropdownPortalId, children, className, }: DropdownMenuProps): JSX_2.Element;
    displayName: string;
...
export declare const Label: default_2.ForwardRefExoticComponent<LabelProps & default_2.RefAttributes<HTMLElement>>;
...
export declare const LineChart: ({ data, dataKeys, colors, showXAxis, showYAxis, showTooltip, tooltipIndicator, tooltipLabelKey, showCartesianGrid, tickFormatter, xAxisDataKey, yAxisDataKey, xAxisFontSize, xAxisFontColor, yAxisFontColor, chartWidth, chartHeight, withDots, }: LineChartProps) => JSX_2.Element;
...
declare function SelectButton({ children, icon, // Icon to show in the select button.
    ...
    className, }: SelectButtonProps): JSX_2.Element;

declare namespace SelectButton {
    var displayName: string;
}

declare interface SelectButtonProps {

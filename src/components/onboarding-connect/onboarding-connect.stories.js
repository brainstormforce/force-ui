...
const Template = (args) => {
	...
	return (
		<OnboardingConnect {...args} className='bg-gray-100 h-screen w-full pb-10' >
			...
			<div className='flex justify-between items-center w-8/12 p-6 mx-auto gap-10 border-border-subtle bg-background-primary rounded-md mt-10'>
				<div>
					<h2>Connect Your Site with SureRank</h2>
					<p>When you connect your free account with SureRank you will get keyword suggestions from Google when entering the keywords. Not only that, you will access to our AI assistant work as a SEO expert and help you get your site ranked. </p>

...
export const GridContainer = {
    ...
    render: (args) => (
        <Container {...args}>
            <Container.Item className="bg-red-500 p-4">Grid Item 1</Container.Item>
            <Container.Item className="bg-green-500 p-4">Grid Item 2</Container.Item>
            <Container.Item className="bg-blue-500 p-4">Grid Item 3</Container.Item>
        </Container>
    ),
};

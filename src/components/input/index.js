...
const Input = ( props ) => {
	...
	const baseClasses = 'rounded border border-solid border-border-subtle bg-field-secondary-background font-normal placeholder-text-tertiary text-text-primary';
	const sizeClasses = {

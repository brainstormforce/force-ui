...
export default {
	...
	argTypes: {
		placement: {
			description: 'Defines the position of the dropdown relative to the trigger element.',
			control: { type: 'select' },
			options: [
		...
		offset: {
			description: 'The distance between the trigger element and the dropdown content.',
			control: { type: 'number' },
			table: {
				type: { summary: 'number' },
			},
		...
		boundary: {
			description: 'The element that the dropdown is positioned relative to. When provided, the dropdown will be positioned within the boundary of the element.',
			table: {

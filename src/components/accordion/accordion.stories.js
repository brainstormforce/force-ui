...
const Template = ( args ) => (
	<Accordion { ...args }>
		...
		<Accordion.Item value="item3" disabled={ args.disabled }>
			...
			<Accordion.Content>
				This is the content of the third accordion item, which is
				disabled. This is the content of the third accordion item, which
				is disabled accordion item, which is disabled.
			</Accordion.Content>
		</Accordion.Item>
	</Accordion>
);

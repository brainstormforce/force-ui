...
const defaultRadioButtonGroupData = [
  {
    ...
    hideSelection: true,
    useSwitch: false,
    bagde: <Badge label={'PRO'} size="md" icon={null} variant="inverse" closable={false}  className='py-0'/>,
  },
  {
    id: '2',
    value: 'notifications',
  ...
  },
  {
    ...
    hideSelection: false,
    useSwitch: true,
    bagde: <Badge label={'New'} size="md"  icon={null} variant="green" closable={false} className='py-0 mr-2'/>,
  },
  {
    id: '11',
  ...
  },
  {
    ...
    hideSelection: false,
    useSwitch: true,
    bagde: <Badge label={'Extension'}  size="md" icon={null} variant="yellow" closable={false}  className='py-0 mr-2'/>,
  },
];
...
const PrestoPlayerSvg = () => {
    return (
        <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.6094 9.93105L19.3338 6.60156V13.2606L13.6094 9.93105Z" fill="#3A30E5"/>
            <path d="M13.6094 3.32812L19.3338 6.65763L13.6094 9.98711V3.32812Z" fill="#3058E5"/>
            <path d="M13.615 3.32812V9.9287L7.89062 6.59922L13.615 3.32812Z" fill="#4067EE"/>
            <path d="M13.6697 3.32948L7.94531 6.65899V0L13.6697 3.32948Z" fill="#476EF9"/>
            <path d="M7.88845 6.66016V13.3191L2.16406 9.98964L7.88845 6.66016Z" fill="#624AF6"/>
            <path d="M7.88845 0V6.65899L2.16406 3.32948L7.88845 0Z" fill="#4067EE"/>
            <path d="M7.88845 13.2578V19.9168L2.16406 16.5873L7.88845 13.2578Z" fill="#7C3AED"/>
            <path d="M13.6094 9.92969L19.3338 13.2592L13.6094 16.5887V9.92969Z" fill="#4F46E5"/>
            <path d="M2.16406 9.92969L7.88845 13.2592L2.16406 16.5887V9.92969Z" fill="#814AF7"/>
            <path d="M2.16406 3.32812L7.88845 6.65763L2.16406 9.98711V3.32812Z" fill="#3058E5"/>
            <path d="M13.615 9.92969V16.5887L7.89062 13.2592L13.615 9.92969Z" fill="#624AF6"/>
            <path d="M13.6094 9.93105L19.3338 6.60156V13.2606L13.6094 9.93105Z" fill="#3A30E5"/>
            <path d="M13.6094 3.32812L19.3338 6.65763L13.6094 9.98711V3.32812Z" fill="#3058E5"/>
            <path d="M13.615 3.32812V9.9287L7.89062 6.59922L13.615 3.32812Z" fill="#4067EE"/>
            <path d="M13.6697 3.32948L7.94531 6.65899V0L13.6697 3.32948Z" fill="#476EF9"/>
      ...
      return (
        <Container className="flex flex-col w-120 border border-solid rounded-md border-border-subtle gap-2 p-4">
            ...
            <Container.Item className="md:w-full lg:w-full bg-field-primary-background rounded-lg">
                <Container className="grid grid-cols-2 gap-2 p-1">
                {astraRadioButtonGroupData.map((card) => (
                    <Container.Item key={card.id} className="md:w-full lg:w-full">
                    <Container className="flex-col shadow-soft-shadow-inner p-2 rounded-md">
                        <Container.Item>
                        <Container className="gap-1 items-center">
                            <Container.Item className="flex-1 [&>svg]:size-5">{card.svg}</Container.Item>
                            <Container.Item>
                            <Badge label={card.badgeText} icon={null} variant="green" closable={false} className="py-0" />
                            </Container.Item>
                            <Container.Item>
                        ...
                        <Label variant="help" className="text-sm">{card.description}</Label>
                        </Container.Item>
                    </Container>
                    </Container.Item>
                ))}
  ...
  const containerRowButtons = [
    {
      ...
      hideSelection: true,
      useSwitch: false,
      bagde: <Badge label={'PRO'} icon={null} variant="inverse" closable={false} />,
    },
    {
      id: '2',
      value: 'helpcenter',

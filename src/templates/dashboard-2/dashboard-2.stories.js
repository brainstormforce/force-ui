...
import { ArrowUpRight, CircleHelp, Megaphone , CirclePlay, Plus, ExternalLink, House, Bell, Settings, Shield, AppWindow, PictureInPicture, Share2, Newspaper, ChartNoAxesGantt, Map, PanelLeftClose, Ellipsis, Headset, HelpCircle, MessageSquare, Star, Zap, Check } from 'lucide-react';
...
import { AstraThemeSvg, StartersTemplatesSvg, SureCartSvg, PrestoPlayerSvg } from "./dashboard-2-svgs";
...
export const Dashboard2 = () => {
    ...
    return (
        <>
            {/* <Alert
                title={ "Unlock Spectra's Full Potential!" }
                content={ 'Get exclusive features and unbeatable performance. Upgrade now' }
                variant="neutral"
                className="w-full"
            /> */}

	...
	return (
		...
		>
			...
			<div className="md:w-[35rem] box-border mx-auto p-8 mt-10 border border-solid border-border-subtle bg-background-primary rounded-md space-y-6">
				...
				<div>
					<img src='https://contenthub-static.grammarly.com/blog/wp-content/uploads/2023/06/BMD-4781.png' alt="Email Setup" className="w-full" />
				</div>
				<div>
					<ul className="divide-y divide-gray-200 list-none pl-0 space-y-2">
						<li className="flex items-start space-x-2 text-field-label text-sm">
							...
							<span>
								Reduce the chances of your emails getting lost in spam.
							</span>
						</li>
						<li className="flex items-start space-x-2 text-field-label text-sm">
							<Check className="size-4 text-icon-primary" />
				...
				<Button className="px-4 w-max">Get Started with Onboarding</Button>
			</div>
		</div>
	);
};
